...
class ChatApp:
    ...
    def setup_ui(self):
        ...
        self.entry = ctk.CTkEntry(self.root, width=350, placeholder_text="Type a message...")
    ...
    def add_message(self, message, sender="other"):
        ...
        frame.pack(anchor="e" if sender == "me" else "w", pady=5, padx=5)
        ...
        while True:
            try:
                ...
                if decoded["user"] != self.username:
                    self.add_message(f"{decoded['user']}: {decoded['msg']}", "other")
